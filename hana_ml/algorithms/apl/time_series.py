...
class AutoTimeSeries(APLBase): #pylint: disable=too-many-instance-attributes
    ...
    def _check_params_before_fit(self, data, key, features):
        """
        ...
        if not self.time_column_name:
            raise RuntimeError('The time column name is unknown. '
        ...
        if not self.target:
            raise RuntimeError('The target column name is required.'
    ...
    def _create_forecast_out(self, data, horizon):
        ...
        Returns
        -------
        A Table object containing the table definition
        """
