"""This module contains PAL wrapper and helper functions for discriminant analysis algorithms.
...
class LinearDiscriminantAnalysis(PALBase):
    ...
    def __init__(self,
                 ...
                 projection=None):
        super(LinearDiscriminantAnalysis, self).__init__(conn_context)
    ...
    def fit(self, data, key=None, features=None, label=None):
        ...
        try:
            self._call_pal_auto('PAL_LINEAR_DISCRIMINANT_ANALYSIS',
                                data,
    ...
    def predict(self, data, key, features=None, verbose=None):
        ...
        try:
            self._call_pal_auto('PAL_LINEAR_DISCRIMINANT_ANALYSIS_CLASSIFY',
                                data,
                                priors,
                                model,
                                ParameterTable().with_data(param_rows),
    ...
    def project(self, data, key, features=None, proj_dim=None):
        ...
        try:
            self._call_pal_auto('PAL_LINEAR_DISCRIMINANT_ANALYSIS_PROJECT',
                                data,
                                proj_model,
                                ParameterTable().with_data(param_rows),
                                projected_tbl)
        ...
        return self.conn_context.table(projected_tbl)
