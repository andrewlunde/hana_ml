...
"""
This module contains wrappers for PAL Exponential Smoothing algorithms.
...
class _ExponentialSmoothingBase(PALBase):# pylint: disable=too-many-arguments,too-many-instance-attributes,too-many-locals,too-few-public-methods
    """
...
# pylint: disable=too-many-arguments,too-many-instance-attributes,too-many-locals,too-few-public-methods,too-many-statements
    def __init__(self,
        ...
        super(_ExponentialSmoothingBase, self).__init__(conn_context)
    ...
    def _fit_predict(self, exp_smooth_function, data, key, endog):
        ...
        param_rows = [
            ...
            ('SEASONAL', self.seasonal, None, None),
            ('INITIAL_METHOD', self.initial_method, None, None),
            ('ACCURACY_MEASURE', None, None, self.accuracy_measure), # auto ESM
            ('MEASURE_NAME', None, None, self.accuracy_measure), # S/D/T ESM
        ...
        try:
            ...
            self._call_pal_auto(pal_function,
                                data,
...
class SingleExponentialSmoothing(_ExponentialSmoothingBase):
    ...
    accuracy_measure : str, optional
        The criterion used for the optimization.
        Available values are "mpe", "mse", "rmse", "et", "mad", "mase", "wmape", "smape", "mape".
        No default value.
...
class AutoExponentialSmoothing(_ExponentialSmoothingBase): #pylint: disable=too-many-instance-attributes, too-few-public-methods, too-many-locals
    r"""
    ...
    model_selection : int, optional
        ...
        Note: If forecast_model_name is set, the model defined by forecast_model_name will be used.
        Defaults to 0.
    ...
    thread_ratio : float, optional
        ...
        The value range is from 0 to 1, where 0 means only using one thread, and 1 means
        using at most all the currently available threads. Values outside the range are
...
class BrownExponentialSmoothing(_ExponentialSmoothingBase):# pylint: disable=too-many-arguments,too-many-instance-attributes,too-many-locals
    r"""
    ...
    accuracy_measure : str, optional
        Measure name. Supported measures are "mpe", "mse", "rmse", "et", "mad", "mase", "wmape", "smape", "mape".
    ...
    >>> brown_exp_smooth = time_series.BrownExponentialSmoothing(conn_context=self.conn,
                                                   alpha=0.1,
                                                   delta=0.2,
                                                   forecast_num=6,
                                                   adaptive_method=False,
    ...
    >>> brown_exp_smooth.fit_predict(df)
...
# pylint: disable=too-many-arguments,too-many-instance-attributes,too-many-locals,too-few-public-methods
    def __init__(self,
        ...
        super(BrownExponentialSmoothing, self).__init__(conn_context,
                                                        alpha=alpha,
                                                        delta=delta,
                                                        forecast_num=forecast_num,
                                                        adaptive_method=adaptive_method,
...
class Croston(_ExponentialSmoothingBase):# pylint: disable=too-many-arguments,too-many-instance-attributes,too-many-locals
    r"""
    ...
    >>> croston = Croston(conn_context=self.conn,
                          alpha=0.1,
                          forecast_num=1,
                          method='sporadic',
...
# pylint: disable=too-many-arguments,too-many-instance-attributes,too-many-locals,too-few-public-methods
    def __init__(self,
        ...
        super(Croston, self).__init__(conn_context,
                                      alpha=alpha,
                                      forecast_num=forecast_num,
                                      accuracy_measure=accuracy_measure,
                                      ignore_zero=ignore_zero,
