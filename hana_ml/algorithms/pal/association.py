"""
This module contains wrapper for **PAL regression algorithm**.
...
#pylint:disable=too-many-lines, line-too-long, too-many-instance-attributes, too-few-public-methods
import logging
import sys
import uuid
...
class _AssociationBase(PALBase):
    ...
    def __init__(self,#pylint:disable=too-many-arguments, too-many-locals
                 ...
                 thread_ratio=None,
                 timeout=None):
        super(_AssociationBase, self).__init__(conn_context)
...
class Apriori(_AssociationBase):#pylint:disable=too-many-instance-attributes
    ...
    def __init__(self,#pylint:disable=too-many-arguments, too-many-locals
                 ...
                 timeout=None,
                 pmml_export=None):
        super(Apriori, self).__init__(conn_context=conn_context,
                                      ...
                                      timeout=timeout)
        #super(Apriori, self).__init__(conn_context)
    ...
    def fit(self, data,#pylint:disable=too-many-arguments, too-many-branches
        ...
        try:
            self._call_pal_auto(apriori_proc,
                                data,
...
class AprioriLite(PALBase):#pylint:disable=too-few-public-methods
    ...
    def __init__(self,#pylint:disable=too-many-arguments
                 ...
                 timeout=None,
                 pmml_export=None):
        super(AprioriLite, self).__init__(conn_context)
    ...
    def fit(self, data, transaction=None, item=None):
        ...
        try:
            self._call_pal_auto('PAL_LITE_APRIORI',
                                data,
                                ParameterTable().with_data(param_rows),
                                *outputs)
        except dbapi.Error as db_err:
...
class FPGrowth(_AssociationBase):#pylint:disable=too-many-instance-attributes
    ...
    def __init__(self,#pylint:disable=too-many-arguments, too-many-locals
                 ...
                 thread_ratio=None,
                 timeout=None):
        super(FPGrowth, self).__init__(conn_context=conn_context,
                                       relational=relational,
                                       min_lift=min_lift,
                                       max_conseq=max_conseq,
                                       max_len=max_len,
    ...
    def fit(self, data,#pylint:disable=too-many-arguments, too-many-branches
        ...
        try:
            self._call_pal_auto(fpgrowth_proc,
                                data,
                                ParameterTable().with_data(param_rows),
                                *output_tbls)
        except dbapi.Error as db_err:
...
class KORD(PALBase):#pylint:disable=invalid-name
    ...
    >>> krd.fit(df, transaction='CUSTOMER', item='ITEM')
    >>> krd.antec_.collect()
    ...
    def __init__(self,#pylint:disable=too-many-arguments
                 ...
                 epsilon=None,
                 use_epsilon=None):
        super(KORD, self).__init__(conn_context)
    ...
    def fit(self, data, transaction=None, item=None):
        ...
        try:
            ...
            raise
        self.antec_ = self.conn_context.table(antec_tbl)#pylint:disable=attribute-defined-outside-init
        self.conseq_ = self.conn_context.table(conseq_tbl)#pylint:disable=attribute-defined-outside-init
...
class SPM(PALBase):#pylint:disable=invalid-name
    ...
    Firstly take a look at the input data:
    ...
    Set up an SPM instance:

    >>> sp = SPM(conn_context=cc,
    ...          min_support=0.5,
    ...          relational=False,
    ...          ubiquitous=1.0,
    ...          max_len=10,
    ...
    >>> sp.fit(df, customer='CUSTID', transaction='TRANSID', item='ITEMS')
    >>> sp.result_.collect()
    ...
    def __init__(self,#pylint:disable=too-many-arguments
                 ...
                 calc_lift=None,
                 timeout=None):
        super(SPM, self).__init__(conn_context)
        self.min_support = self._arg('min_support', min_support, float, required=True)
        self.relational = self._arg('relational', relational, bool)
        self.max_len = self._arg('max_len', max_len, int)
    ...
    def fit(self, data,#pylint:disable=too-many-branches, too-many-locals, too-many-arguments, too-many-statements
        ...
        try:
            ...
            raise
        if self.relational in (None, False):
            self.result_ = self.conn_context.table(result_tbl)#pylint:disable=attribute-defined-outside-init
        else:
            self.pattern_ = self.conn_context.table(pattern_tbl)#pylint:disable=attribute-defined-outside-init
            self.stats_ = self.conn_context.table(stats_tbl)#pylint:disable=attribute-defined-outside-init
