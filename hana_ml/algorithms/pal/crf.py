"""
This module contains PAL python wrapper functions for conditional random field(CRF).
...
class CRF(PALBase):
    ...
    ...           word_shape=0,
    ...           thread_ratio=1.0)
    >>> crf.fit(df, doc_id="DOC_ID", word_pos="WORD_POSITION",
    ...
    >>> res = crf.predict(df_pred, doc_id='DOC_ID', word_pos='WORD_POSITION',
    ...
    def __init__(self,
                 ...
                 word_shape=None,
                 thread_ratio=None):
        super(CRF, self).__init__(conn_context)
    ...
    def fit(self,
        ...
        data = data[used_cols]
        #data_tbl = "#PAL_CRF_DATA_TBL_{}".format(self.id)
        param_rows = [
        ...
        try:
            ...
            #msg = "HANA error when fitting CRF model."
        ...
        self.optim_param_ = self.conn_context.table(optim_param_tbl)
    ...
    def predict(self,
        ...
        try:
            ...
            #self._call_pal_auto('PAL_CRF_INFERENCE',
            #                    data,
            #                    model,
            #                    ParameterTable().with_data(param_rows),
            #                    result_tbl)
        except dbapi.Error as db_err:
            #msg = "HANA error during CRF prediction."
            logger.exception(str(db_err))
            self._try_drop(tables)
